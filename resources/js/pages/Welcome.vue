    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">WELCOME TO THE MY ASSESSMENT</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        This project has built-in authentication.<br /><br />
                        Please proceed to register yourself to use the application (no email verification required 😁)                    
                    </p>
                     Features you will find:<br /><br />
                        <ol>
                            <li>✅ A table of Product Master List</li>
                            <li>✅ an Excel upload mechanism</li>
                            <li>✅ a Background compilation of Excel file</li>
                            <li>✅ Update of Product Master data as per Excel</li>
                            <li>✅ Notification alert upon 1st upload and compilation of background Job</li>
                        </ol>    
                </div>
                <div
